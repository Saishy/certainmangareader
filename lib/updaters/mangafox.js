...
CMUPDATER.mangafox.GetListOfChapters = function GetListOfChapters(domText, mangaURL) {
	var re = /\(([\s|\S]*?)\)\;/mi;
	var m;
...
CMUPDATER.mangafox.RequestUpdate = function RequestUpdate(mangaData, callBackFnc) {
