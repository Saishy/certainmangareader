...
CMUPDATER.mangahere.GetListOfChapters = function GetListOfChapters(domText, mangaURL) {
	var re = /\(([\s|\S]*?)\)\;/mi;
	var m;
...
CMUPDATER.mangahere.RequestUpdate = function RequestUpdate(mangaData, callBackFnc) {
