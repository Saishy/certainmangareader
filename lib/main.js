...
CERTAINMANGA.SendMessage = function SendMessage(messageType, messageParameter){
	console.log("CERTAINMANGA::SendMessage called with messageType: " + messageType);
		...
		if (!CERTAINMANGA.ChaptersEqual(mangaData.chapters,newChapters)) {
			...
			if (CERTAINMANGA.data.bNotifications) {
				...
				browser.notifications.create(mangaData.name + mangaData.site, {
					...
					message: nText,
					iconURL: browser.extension.getURL('../data/img/icon-64.png')
...
CERTAINMANGA.UpdateNextManga = function UpdateNextManga() {
	...
	if (CERTAINMANGA.data.mangaList[CERTAINMANGA.currentlyUpdating]) {
		...
		if (mangaTemp.site == "Batoto") {
			...
			CMUPDATER.updaters.batoto.RequestUpdate(mangaTemp, CERTAINMANGA.UpdateMangaResponse)
		} else if (mangaTemp.site == "Mangafox") {
			//console.log(mangaTemp.mangaURL);
			CMUPDATER.updaters.mangafox.RequestUpdate(mangaTemp, CERTAINMANGA.UpdateMangaResponse);
		} else if (mangaTemp.site == "Mangastream") {
			//console.log(mangaTemp.mangaURL);
			CMUPDATER.updaters.mangastream.RequestUpdate(mangaTemp, CERTAINMANGA.UpdateMangaResponse);
		} else if (mangaTemp.site == "Mangareader") {
			//console.log(mangaTemp.mangaURL);
			CMUPDATER.updaters.mangareader.RequestUpdate(mangaTemp, CERTAINMANGA.UpdateMangaResponse);
		} else if (mangaTemp.site == "Mangahere") {
			//console.log(mangaTemp.mangaURL);
			CMUPDATER.updaters.mangahere.RequestUpdate(mangaTemp, CERTAINMANGA.UpdateMangaResponse);
		} else if (mangaTemp.site == "Readmangatoday") {
			//console.log(mangaTemp.mangaURL);
			CMUPDATER.updaters.readmangatoday.RequestUpdate(mangaTemp, CERTAINMANGA.UpdateMangaResponse);
		}
