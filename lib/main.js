/* TODO:
 * * Port requires() to WebExtension equivalents. See:
...
if (typeof CERTAINMANGA == 'undefined' || CERTAINMANGA == null) {
	...
	CERTAINMANGA.pageModOptions = {
		"addStar": browser.extension.getURL("img/add-star-24.png"),
		"removeStar": browser.extension.getURL("img/remove-star-24.png"),
		"home": browser.extension.getURL("img/home-24.png"),
		"back": browser.extension.getURL("img/back-24.png"),
		"next": browser.extension.getURL("img/next-24.png"),
		"flag": browser.extension.getURL("img/flag-24.png"),
		"single": browser.extension.getURL("img/single-24.png"),
		"double": browser.extension.getURL("img/double-24.png"),
		"loadingIcon": browser.extension.getURL("img/circle-loading.gif"),
		"batoto": browser.extension.getURL("img/icon-batoto.png"),
		"mangafox": browser.extension.getURL("img/icon-mangafox.png"),
		"mangastream": browser.extension.getURL("img/icon-mangastream.png"),
		"mangareader": browser.extension.getURL("img/icon-mangareader.png"),
		"mangahere": browser.extension.getURL("img/icon-mangahere.png"),
		"readmangatoday": browser.extension.getURL("img/icon-readmangatoday.png"),
		"gear": browser.extension.getURL("img/gear-16.png"),
		"play": browser.extension.getURL("img/play-16.png"),
		"remove": browser.extension.getURL("img/remove-16.png"),
		"mark": browser.extension.getURL("img/mark-16.png"),
		"mangastreamCover": browser.extension.getURL("img/mangastream-cover.png"),
		"error404": browser.extension.getURL("img/error404.png")
	};
...
// 	icon: {
// 		"16": browser.extension.getURL("img/icon-16.png"),
// 		"32": browser.extension.getURL("img/icon-32.png"),
// 		"64": browser.extension.getURL("img/icon-64.png")
// 	},
...
// 		contentURL: browser.extension.getURL("main_panel.html"),
// 		contentScriptFile: browser.extension.getURL('main_panel.js'),
// 		contentStyleFile: browser.extension.getURL('main_panel.css'),
...
//		include: browser.extension.getURL("import_export.html"),
//		contentScriptFile: [browser.extension.getURL("import_export.js")],
//		contentStyleFile: [browser.extension.getURL("import_export.css")],
...
CERTAINMANGA.UpdateNextManga = function UpdateNextManga() {
	...
	if (CERTAINMANGA.data.mangaList[CERTAINMANGA.currentlyUpdating]) {
		...
		if (mangaTemp.site == "Batoto") {
			...
			//CERTAINMANGA.updatePageWorker.contentScriptFile = [browser.extension.getURL("updaters/batoto_updater.js")];
			CERTAINMANGA.StartPageWorker(mangaTemp, browser.extension.getURL("updaters/batoto.js"), mangaTemp.chapters[0].url);
...
// 		contentScriptFile: [browser.extension.getURL("menu.js"), browser.extension.getURL("readers/cmreader.js"), browser.extension.getURL("readers/batoto.js")],
// 		contentStyleFile: [browser.extension.getURL("menu.css"), browser.extension.getURL("readers/cmreader.css"), browser.extension.getURL("readers/batoto.css")],
// 		contentScriptWhen: 'ready',
...
// 		contentScriptFile: [browser.extension.getURL("menu.js"), browser.extension.getURL("readers/cmreader.js"), browser.extension.getURL("readers/mangafox.js")],
// 		contentStyleFile: [browser.extension.getURL("menu.css"), browser.extension.getURL("readers/cmreader.css"), browser.extension.getURL("readers/mangafox.css")],
// 		contentScriptWhen: 'ready',
// 		contentScriptOptions: CERTAINMANGA.pageModOptions,
// 		attachTo: "top",
// 		onAttach: function(worker) {
...
// 		contentScriptFile: [browser.extension.getURL("menu.js"), browser.extension.getURL("readers/cmreader.js"), browser.extension.getURL("readers/mangastream.js")],
// 		contentStyleFile: [browser.extension.getURL("menu.css"), browser.extension.getURL("readers/cmreader.css"), browser.extension.getURL("readers/mangastream.css")],
// 		contentScriptWhen: 'ready',
// 		contentScriptOptions: CERTAINMANGA.pageModOptions,
// 		attachTo: "top",
// 		onAttach: function(worker) {
...
// 		contentScriptFile: [browser.extension.getURL("menu.js"), browser.extension.getURL("readers/cmreader.js"), browser.extension.getURL("readers/mangareader.js")],
// 		contentStyleFile: [browser.extension.getURL("menu.css"), browser.extension.getURL("readers/cmreader.css"), browser.extension.getURL("readers/mangareader.css")],
// 		contentScriptWhen: 'ready',
// 		contentScriptOptions: CERTAINMANGA.pageModOptions,
// 		attachTo: "top",
// 		onAttach: function(worker) {
...
// 		contentScriptFile: [browser.extension.getURL("menu.js"), browser.extension.getURL("readers/cmreader.js"), browser.extension.getURL("readers/mangahere.js")],
// 		contentStyleFile: [browser.extension.getURL("menu.css"), browser.extension.getURL("readers/cmreader.css"), browser.extension.getURL("readers/mangahere.css")],
// 		contentScriptWhen: 'ready',
// 		contentScriptOptions: CERTAINMANGA.pageModOptions,
// 		attachTo: "top",
// 		onAttach: function(worker) {
...
// 		contentScriptFile: [browser.extension.getURL("menu.js"), browser.extension.getURL("readers/cmreader.js"), browser.extension.getURL("readers/readmangatoday.js")],
// 		contentStyleFile: [browser.extension.getURL("menu.css"), browser.extension.getURL("readers/cmreader.css"), browser.extension.getURL("readers/readmangatoday.css")],
// 		contentScriptWhen: 'ready',
// 		contentScriptOptions: CERTAINMANGA.pageModOptions,
// 		attachTo: "top",
// 		onAttach: function(worker) {
...
CERTAINMANGA.StartAddon = function StartAddon() {
	...
	if (CERTAINMANGA.data.updateTime > 0) {
		/* TODO: This is already ported to alarm: fix where needed
		* CERTAINMANGA.alarm = browser.alarms.create("time", {
		* 	"periodInMinutes": 1
		* })
		*/
...
CERTAINMANGA.StoreData = function StoreData() {
	function onError(error) {
	  console.log(`ACMR: Failed to set internal options: ${error}`);
	}
	let storedata = browser.storage.local.set(CERTAINMANGA.data);
	storedata.then(null, onError);
}
CERTAINMANGA.StoreData();

CERTAINMANGA.ListenMessages = function ListenMessages(message){
	console.debug("ACMR (main): Received a message");
