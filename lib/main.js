...
CERTAINMANGA.SendMessage = function SendMessage(messageType, messageParameter){
	console.log("CERTAINMANGA::SendMessage " + messageType);
...
CERTAINMANGA.HandleError = function HandleError(error){
	console.error("ACMR (main) - Something bad happened:");
	console.error(error);
};
...
CERTAINMANGA.OpenDatabase = function OpenDatabase() {
	...
	var request = indexedDB.open("ACertainMangaReaderDatabase", { version: 1, storage: "persistent" });
...
// 	icon: {
// 		"16": browser.extension.getURL("data/img/icon-16.png"),
// 		"32": browser.extension.getURL("data/img/icon-32.png"),
// 		"64": browser.extension.getURL("data/img/icon-64.png")
// 	},
...
// 		contentScriptOptions: {data: CERTAINMANGA.data, filesRef: CERTAINMANGA.filesRef},
...
// 		contentScriptWhen: 'ready',
// 		contentScriptOptions: CERTAINMANGA.filesRef,
// 		attachTo: "top",
// 		onAttach: function(worker) {
