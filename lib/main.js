...
CERTAINMANGA.ListenMessages = function ListenMessages(message){
	...
	switch (message.type) {
		...
		case "GetDataFromMain":
			...
			break;
		case "GetPMOsFromMain":
			CERTAINMANGA.SendMessage("SendPMOsFromMain", CERTAINMANGA.pageModOptions);
			break;
		case "GetPMOsFromMainToTab":
			CERTAINMANGA.SendMessageToCurrentTab("SendPMOsFromMainToTab", CERTAINMANGA.pageModOptions);
			break;
		case "OpenTab":
