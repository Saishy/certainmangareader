if (typeof CMHTMLHELPER == 'undefined' || CMHTMLHELPER == null) {
	CMHTMLHELPER = {};
}

//Credits to Joel Moss, http://developwithstyle.com
CMHTMLHELPER.EntityToHTML = function EntityToHTML(string) {
	for (var i in CMHTMLHELPER.entity_table) {
		if (i != 38) {
			string = string.replace(new RegExp(CMHTMLHELPER.entity_table[i], "g"), String.fromCharCode(i));
		}
	}
	...
	string = string.replace(new RegExp(CMHTMLHELPER.entity_table[38], "g"), String.fromCharCode(38));

	return string;
};

CMHTMLHELPER.entity_table = {
	34: "&quot;",     // Quotation mark. Not required
	38: "&amp;",        // Ampersand. Applied after everything else in the application
	60: "&lt;",     // Less-than sign
...
exports.EntityToHTML = CMHTMLHELPER.EntityToHTML;